...
class masterPlu extends Component {
  ...
  componentDidMount = () =>  {
    ...
    axios
    .get(`http://localhost:3009/centralkitchen/getMasterPLU`)
    .then(result => {
      this.setState({
        ...this.state,
  ...
  modalEditOpen = async (data) =>  {
    ...
    await axios
    .post(`http://localhost:3009/centralkitchen/getDetailMasterPLU`, dataToSend, {
      headers: {
  ...
  submitData = () => {
    ...
    if (this.state.tambahnamaplu == ""){
      ...
      console.log(dataToSend);
        ...
        axios
        .post(`http://localhost:3009/centralkitchen/addMasterPLU`, dataToSend, {
            headers: {
            "Access-Control-Allow-Origin": "*"
            }
        })
  ...
  updateData = () => {
    ...
    axios
    .post(`http://localhost:3009/centralkitchen/updateMasterPLU`, dataToSend, {
      headers: {
        "Access-Control-Allow-Origin": "*"
      }
    })
